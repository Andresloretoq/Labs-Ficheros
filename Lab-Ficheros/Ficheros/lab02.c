...
* ================================================
* Resumen:
El programa recibe el nombre de un directorio y muestra los nombres de los archivos y subdirectorios que contiene, indicando sus permisos, si el propietario tiene permiso de lectura, si son directorios y, en el caso de los archivos modificados en los últimos diez días, la fecha de su último acceso.
*/
